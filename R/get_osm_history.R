...
#'
#' @return En el cas que l'objecte sigui una relació, retorna una llista amb dos `data.frames`, un amb els membres de
#'   totes les versions de l'objecte i un amb tots els tags, el número de versió, la id del changeset, la data del
#'   canvi, el nom de l'usuari que el va fer i el seu uid. En cas que sigui una via, retorna una llista amb dos
#'   `data.frame`, un amb tots els nodes que formen la via i un amb tots els tags. En cas que sigui un node, retorna un
#'   `data.frame` amb informació sobre tots els canvis i tags'
#' @export
#'
#' @examples
#' \dontrun{
